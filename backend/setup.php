...
CREATE TABLE admissions (
  ...
  parent_occupation VARCHAR(120) DEFAULT NULL,
  address TEXT DEFAULT NULL,
...
SQL,
    ...
    insertRows($pdo, "INSERT INTO settings (setting_key,setting_value) VALUES (?,?)", [
        ...
        ['grading_ranges','[{"grade":"A","min":80,"max":100,"remark":"Excellent"},{"grade":"B","min":70,"max":79,"remark":"Very Good"},{"grade":"C","min":60,"max":69,"remark":"Good"},{"grade":"D","min":50,"max":59,"remark":"Average"},{"grade":"F","min":0,"max":49,"remark":"Fail"}]'],
        ['maintenance_mode','0'],
